...
class SearchBar extends React.Component {
  ...
  handleInStockChange(e) {
    this.props.onInStockCange(e.target.checked)
  }
  render() {
    const filterText = this.props.filterText
    const inStockOnly = this.props.inStockOnly
...
class FilterableProductTable extends React.Component {
  ...
  render() {
    return(
      <div>
        <SearchBar filterText={this.state.filterText} inStockOnly={this.state.inStockOnly} onFilterTextChange={this.handleFilterTextChange} onInStockCange={this.handleInStockChange}></SearchBar>
